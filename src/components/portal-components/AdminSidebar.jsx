...
const tabs = [
  ...
  { key: "eventsandannouncements", label: "Add Events and Announcements", icon: <FaImages /> },
]
      ...
      >
        <div className="flex flex-col h-full p-6">
          <div className="mb-4">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold text-blue-900 text-center mb-2">Admin Portal</h1>
